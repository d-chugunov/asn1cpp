...
asn_TYPE_descriptor_t asn_DEF_TeletexString = {
	"TeletexString",
	"TeletexString",
	OCTET_STRING_print<TeletexString, std::string>,         /* non-ascii string */
	asn_generic_unknown_constraint,
	OCTET_STRING_decode_ber<TeletexString, std::string>,    /* Implemented in terms of OCTET STRING */
	OCTET_STRING_encode_der<TeletexString, std::string>,
