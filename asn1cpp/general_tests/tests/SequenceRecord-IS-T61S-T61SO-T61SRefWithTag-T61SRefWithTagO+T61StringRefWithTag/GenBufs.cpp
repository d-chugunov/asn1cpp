...
#include "GenBufs.hpp"
#include "SequenceRecord-IS-T61S-T61SO-T61SRefWithTag-T61SRefWithTagO.h"
#include "time.h"
...
std::vector<uint8_t> Buf1() {
  ...
  SequenceRecord_IS_T61S_T61SO_T61SRefWithTag_T61SRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  SetString(rec.seq.str3, string3);
  asn_enc_rval_t rval;
  rval = der_encode_to_buffer(&asn_DEF_SequenceRecord_IS_T61S_T61SO_T61SRefWithTag_T61SRefWithTagO, &rec, (void*)buf.data(), buf.size());
  if (rval.encoded >= 0) {
...
std::vector<uint8_t> Buf2() {
  ...
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  rec.seq.str2 = (T61String_t*)malloc(sizeof(T61String_t));
  SetString(*rec.seq.str2, string2);
  SetString(rec.seq.str3, string3);
  rec.seq.str4 = (T61StringRefWithTag_t*)malloc(sizeof(T61StringRefWithTag_t));
