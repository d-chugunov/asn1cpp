...
std::vector<uint8_t> Buf1() {
  ...
  SequenceRecord_IS_GraS_GraSO_GraSRefWithTag_GraSRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  SetString(rec.seq.str3, string3);
  asn_enc_rval_t rval;
  rval = der_encode_to_buffer(&asn_DEF_SequenceRecord_IS_GraS_GraSO_GraSRefWithTag_GraSRefWithTagO, &rec, (void*)buf.data(), buf.size());
  if (rval.encoded >= 0) {
...
std::vector<uint8_t> Buf2() {
 ...
 SequenceRecord_IS_GraS_GraSO_GraSRefWithTag_GraSRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  rec.seq.str2 = (GraphicString_t*)malloc(sizeof(GraphicString_t));
  SetString(*rec.seq.str2, string2);
  SetString(rec.seq.str3, string3);
  rec.seq.str4 = (GraStringRefWithTag_t*)malloc(sizeof(GraStringRefWithTag_t));
