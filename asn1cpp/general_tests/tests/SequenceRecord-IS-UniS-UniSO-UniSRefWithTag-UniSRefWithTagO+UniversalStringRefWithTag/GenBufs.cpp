...
#include "GenBufs.hpp"
#include "SequenceRecord-IS-UniS-UniSO-UniSRefWithTag-UniSRefWithTagO.h"
#include "time.h"
...
std::vector<uint8_t> Buf1() {
  ...
  SequenceRecord_IS_UniS_UniSO_UniSRefWithTag_UniSRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  SetString(rec.seq.str3, string3);
  asn_enc_rval_t rval;
  rval = der_encode_to_buffer(&asn_DEF_SequenceRecord_IS_UniS_UniSO_UniSRefWithTag_UniSRefWithTagO, &rec, (void*)buf.data(), buf.size());
  if (rval.encoded >= 0) {
...
std::vector<uint8_t> Buf2() {
  ...
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  rec.seq.str2 = (UniversalString_t*)malloc(sizeof(UniversalString_t));
  SetString(*rec.seq.str2, string2);
  SetString(rec.seq.str3, string3);
  rec.seq.str4 = (UniversalStringRefWithTag_t*)malloc(sizeof(UniversalStringRefWithTag_t));
