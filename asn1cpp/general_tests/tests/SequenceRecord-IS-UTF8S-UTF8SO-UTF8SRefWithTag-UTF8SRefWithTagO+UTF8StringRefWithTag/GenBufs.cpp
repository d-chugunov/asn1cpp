...
#include "GenBufs.hpp"
#include "SequenceRecord-IS-UTF8S-UTF8SO-UTF8SRefWithTag-UTF8SRefWithTagO.h"
#include "time.h"
...
std::vector<uint8_t> Buf1() {
  ...
  SequenceRecord_IS_UTF8S_UTF8SO_UTF8SRefWithTag_UTF8SRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  SetString(rec.seq.str3, string3);
  asn_enc_rval_t rval;
  rval = der_encode_to_buffer(&asn_DEF_SequenceRecord_IS_UTF8S_UTF8SO_UTF8SRefWithTag_UTF8SRefWithTagO, &rec, (void*)buf.data(), buf.size());
  if (rval.encoded >= 0) {
...
std::vector<uint8_t> Buf2() {
  ...
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  rec.seq.str2 = (UTF8String_t*)malloc(sizeof(UTF8String_t));
  SetString(*rec.seq.str2, string2);
  SetString(rec.seq.str3, string3);
  rec.seq.str4 = (UTF8StringRefWithTag_t*)malloc(sizeof(UTF8StringRefWithTag_t));
