...
std::vector<uint8_t> Buf1() {
  ...
  SequenceRecord_IS_IA5S_IA5SO_IA5SRefWithTag_IA5SRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  SetString(rec.seq.str3, string3);
  asn_enc_rval_t rval;
  rval = der_encode_to_buffer(&asn_DEF_SequenceRecord_IS_IA5S_IA5SO_IA5SRefWithTag_IA5SRefWithTagO, &rec, (void*)buf.data(), buf.size());
  if (rval.encoded >= 0) {
...
std::vector<uint8_t> Buf2() {
 ...
 SequenceRecord_IS_IA5S_IA5SO_IA5SRefWithTag_IA5SRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  rec.seq.str2 = (IA5String_t*)malloc(sizeof(IA5String_t));
  SetString(*rec.seq.str2, string2);
  SetString(rec.seq.str3, string3);
  rec.seq.str4 = (IA5StringRefWithTag_t*)malloc(sizeof(IA5StringRefWithTag_t));
