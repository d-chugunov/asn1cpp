...
#include "GenBufs.hpp"
#include "SequenceRecord-IS-GenS-GenSO-GenSRefWithTag-GenSRefWithTagO.h"
#include "time.h"
...
std::vector<uint8_t> Buf1() {
  ...
  SequenceRecord_IS_GenS_GenSO_GenSRefWithTag_GenSRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  SetString(rec.seq.str3, string3);
  asn_enc_rval_t rval;
  rval = der_encode_to_buffer(&asn_DEF_SequenceRecord_IS_GenS_GenSO_GenSRefWithTag_GenSRefWithTagO, &rec, (void*)buf.data(), buf.size());
  if (rval.encoded >= 0) {
...
std::vector<uint8_t> Buf2() {
 ...
 SequenceRecord_IS_GenS_GenSO_GenSRefWithTag_GenSRefWithTagO_t rec;
  memset(&rec, 0, sizeof(rec));
  SetString(rec.seq.str1, string1);
  rec.seq.str2 = (GeneralString_t*)malloc(sizeof(GeneralString_t));
  SetString(*rec.seq.str2, string2);
  SetString(rec.seq.str3, string3);
  rec.seq.str4 = (GenStringRefWithTag_t*)malloc(sizeof(GenStringRefWithTag_t));
