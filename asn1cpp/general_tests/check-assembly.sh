...
check-executable: compiled-module ../../*.cpp ../../*.hpp
	@rm -f *.core
...
do_check secure-ptrs "" "-DENABLE_ANOTHER_PRINT_FUNC -DDEBUG"
do_check secure-ptrs-no-switch -fno-switch "-DSKIP_ANOTHER_PRINT_FUNC_TESTS -DDEBUG"
do_check insecure-ptrs -finsecure-pointers "-DINSECURE_POINTERS -DENABLE_ANOTHER_PRINT_FUNC -DDEBUG"
do_check insecure-ptrs-no-switch "-finsecure-pointers -fno-switch" "-DINSECURE_POINTERS -DENABLE_ANOTHER_PRINT_FUNC -DDEBUG"
do_check secure-ptrs-ptr-choice-getters "-fptr-choice-getters" "-DENABLE_ANOTHER_PRINT_FUNC -DDEBUG -DPTR_CHOICE_GETTERS"
