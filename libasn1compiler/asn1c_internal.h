...
typedef struct arg_s {
  ...
  /* for internal class. If gen_inner_class_declaration == 1 only 
   * internal declaration classes will be generated. If 
   * gen_inner_class_declaration == 0 only class fields will be generated */
  int gen_inner_class_declaration; 
  int comment_code;
  int ignore_code;
} arg_t;
